...
(
    resume_reference_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    created_date timestamp with time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    modified_date timestamp with time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    is_deleted boolean NOT NULL DEFAULT false,
    is_active boolean NOT NULL DEFAULT true,
    ...
    CONSTRAINT pk_resume_references PRIMARY KEY (resume_reference_id),
    CONSTRAINT fk_resume_references_resume_id_resumes FOREIGN KEY (resume_id)
        REFERENCES public.resumes (resume_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
