...
CREATE TABLE public.resume_projects(
    resume_project_id INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (INCREMENT 1 START 1),
    created_date TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    modified_date TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    is_deleted BOOLEAN NOT NULL DEFAULT false,
    is_active BOOLEAN NOT NULL DEFAULT true,
	...
	is_continued BOOLEAN NOT NULL,
	end_date DATE,
    CONSTRAINT pk_resume_projects PRIMARY KEY(resume_project_id),
    CONSTRAINT fk_resume_projects_resume_id_resumes FOREIGN KEY (resume_id) REFERENCES public.resumes(resume_id)
);

CREATE TABLE public.resume_certificates(
    resume_certificate_id INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (INCREMENT 1 START 1),
    created_date TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    modified_date TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    is_deleted BOOLEAN NOT NULL DEFAULT false,
    is_active BOOLEAN NOT NULL DEFAULT true,
	...
	is_limitless BOOLEAN NOT NULL,
	end_date DATE,
    CONSTRAINT pk_resume_certificates PRIMARY KEY(resume_certificate_id),
    CONSTRAINT fk_resume_certificates_resume_id_resumes FOREIGN KEY (resume_id) REFERENCES public.resumes(resume_id)
);

CREATE TABLE public.resume_skills
(
    resume_skill_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    ...
    CONSTRAINT pk_resume_skills PRIMARY KEY (resume_skill_id),
    CONSTRAINT fk_resume_skills_resume_id_resumes FOREIGN KEY (resume_id)
        REFERENCES public.resumes (resume_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT fk_resume_skills_skill_id_skill FOREIGN KEY (resume_skill_id)
        REFERENCES public.skills (skill_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT fkjqms6u1hi0waox2ugyvrcjwl1 FOREIGN KEY (skill_id)
        REFERENCES public.skills (skill_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
...
(
    ...
    CONSTRAINT uc_skills_name UNIQUE (name),
    CONSTRAINT fk_skills_created_user_id_users FOREIGN KEY (created_user_id)
        REFERENCES public.users (user_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT fk_skills_modified_user_id_users FOREIGN KEY (modified_user_id)
        REFERENCES public.users (user_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);

CREATE TABLE public.resume_referances(
    resume_referance_id INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (INCREMENT 1 START 1),
    created_date TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    modified_date TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    is_deleted BOOLEAN NOT NULL DEFAULT false,
    is_active BOOLEAN NOT NULL DEFAULT true,
    ...
    CONSTRAINT pk_resume_referances PRIMARY KEY(resume_referance_id),
    CONSTRAINT fk_resume_referances_resume_id_resumes FOREIGN KEY (resume_id) REFERENCES public.resumes(resume_id)
);
